...
public:
	...
	[[nodiscard]] bool devFeaturesEnabled() const { return _devFeaturesEnabled.current(); }
	...
	[[nodiscard]] bool autoSpaceSending() const { return _autoSpaceSending.current(); }
	[[nodiscard]] bool autoSpaceEditing() const { return _autoSpaceEditing.current(); }
	[[nodiscard]] bool autoSpaceReceiving() const { return _autoSpaceReceiving.current(); }
	...
	void setAutoSpaceSending(bool val);
	void setAutoSpaceEditing(bool val);
	void setAutoSpaceReceiving(bool val);
	...
	[[nodiscard]] rpl::producer<bool> autoSpaceSendingValue() const { return _autoSpaceSending.value(); }
	[[nodiscard]] rpl::producer<bool> autoSpaceSendingChanges() const { return _autoSpaceSending.changes(); }
	[[nodiscard]] rpl::producer<bool> autoSpaceEditingValue() const { return _autoSpaceEditing.value(); }
	[[nodiscard]] rpl::producer<bool> autoSpaceEditingChanges() const { return _autoSpaceEditing.changes(); }
	[[nodiscard]] rpl::producer<bool> autoSpaceReceivingValue() const { return _autoSpaceReceiving.value(); }
	[[nodiscard]] rpl::producer<bool> autoSpaceReceivingChanges() const { return _autoSpaceReceiving.changes(); }
...
private:
	...
	rpl::variable<bool> _autoSpaceSending = false;
	rpl::variable<bool> _autoSpaceEditing = false;
	rpl::variable<bool> _autoSpaceReceiving = false;
